const listadoFrases = [
  ...
  },
  {
    autor: "Grovyle",
    frase:
      "Lo importante no es cuánto tiempo vives. Es lo que logras con tu vida.",
  },
  {
    autor: "Ash Ketchum",
  ...
  },
  {
    autor: "Ash Ketchum",
    frase:
      "Verás, a veces los amigos tienen que irse, pero una parte de ellos se queda contigo.",
  },
  {
    autor: "Mariscal",
    frase:
      "Incluso si pierdes en la batalla, si superas lo que has hecho antes, te has superado a ti mismo.",
  },
];

export default function asignarFrases() {
  const frases = listadoFrases;
  ...
  autorFrase.textContent = frases[numeroRandom].autor;
  textoFrase.textContent = frases[numeroRandom].frase;
}
